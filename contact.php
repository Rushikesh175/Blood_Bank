...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Dayananda sagar hospitals &amp; <br>Dayananda Sagar Academy of Technology and management <br>
					opp.art of living.<br>
					Kanakapura Road<br>
					Banglore
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone number</abbr>: 9866314553</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="#" >bloodbankin@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Availability</abbr>: 24*7 hours</p>
